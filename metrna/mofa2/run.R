...
io$outdir <- paste0(io$basedir,"/metrna/mofa2")
...
# Predictions
pred.dt <- lapply(met.views, function(m) 
...
hist(pred.dt$value)
fwrite(pred.dt, paste0(io$outdir,"/imputed_data.txt.gz"))
...
plot_factor(MOFAobject, factors=1, dot_size = 3, group_by = "group", color_by = "lineage10x_2", dodge=T)
...
plot_data_heatmap(MOFAobject, 
  factor = 1, 
  view = "met_H3K27ac_distal_E7.5_Mes_intersect12", 
  imputed = F,
  denoise = T,
