---
title: "Gastrulation: local correlation between DNA methylation and RNA expression in ESC"
output: 
...
io$outdir <- "/Users/ricard/gastrulation/metrna/local_coupling/comparison/ESC/out"
...
```{r}
metrna <- merge(met_dt, rna_dt, by=c("sample","ens_id","culture"))
rm(met_dt,rna_dt)
```
...
pdf(file=paste0(io$outdir,"/metrna_localcoupling_ESC.pdf"), width=5, height=3.5)
print(p)
dev.off()
```
