---
title: "Gastrulation: Coupling between RNA expression and chromatin accessibility in scNMT-ESC"
output: 
...
# Data
io   <- list()
io$base_dir   <- "/Users/ricard/data/NMT-seq_ESC"
io$in.sample_metadata <- paste0(io$base_dir,"/sample_metadata.txt")
io$annos_dir  <- paste0(io$base_dir, "/features/filt")
io$rna_file   <- paste0(io$base_dir, "/rna/parsed/sce.rds")
io$acc_dir   <- paste0(io$base_dir, "/acc/parsed")
io$outdir <- "/Users/ricard/gastrulation/accrna/coupling/comparison/out"
