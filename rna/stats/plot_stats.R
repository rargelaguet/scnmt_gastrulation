######################################################
## Gastrulation scNMT-seq: script to plot RNA stats ##
######################################################
...
io <- list()
io$stats <- "/Users/ricard/data/gastrulation/rna/stats/rna_stats.txt"
io$metadata.file <- "/Users/ricard/data/gastrulation/sample_metadata.txt"
io$outdir <- "/Users/ricard/data/gastrulation/rna/stats/pdf"
