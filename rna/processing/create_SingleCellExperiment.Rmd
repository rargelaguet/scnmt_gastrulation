...
io$raw_counts <- "/Users/ricard/data/gastrulation/rna/counts/counts.txt.gz"
io$outfile <- "/Users/ricard/data/gastrulation/rna/parsed/SingleCellExperiment.rds"
```
...
counts <- fread(sprintf("%s",io$raw_counts)) %>% matrix.please
```
