...
args$outdir <- paste0(io$basedir,"/results/rna/celltype_assignment/E4.5")
## END TEST ##
...
opts$marker_genes <- list(
  "Primitive_endoderm" = c("Fgf4","Igfbp2","Tdgf1","Lef1","Mcf2"), 
  "Epiblast" = c("Lrpap1","Sparc","Ctsl","Ctsh","Serpinh1")
)
...
fwrite(to_save, file.path(args$outdir,"celltype_assignment_E45.txt.gz"), sep="\t")
