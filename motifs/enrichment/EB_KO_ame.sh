...
indir="/bi/scratch/Stephen_Clark/EB_data_new_May2019/met/differential/feature_level/fasta"
pwm="/bi/scratch/Stephen_Clark/gastrulation_data/features/sjc/PWM/JASPAR2018_CORE_vertebrates_non-redundant_pfms_meme.txt"
outdir="/bi/scratch/Stephen_Clark/EB_data_new_May2019/acc/differential/feature_level/motif_enrichment/background_all_k27ac"
