...
io$anno_dir <- paste0(io$base_dir,"/features/sjc/motifs/fimo/bed")
io$raw_acc <- paste0(io$base_dir, "/acc/raw") # raw accessibility (or methylation) data
io$meta_data <- paste0(io$base_dir, "/sample_metadata_scNMT.txt")
