...
io$acc_motif_data <- paste0(io$base_dir, "/acc/motifs/profiles/out/accessibility_at_motifs_e7.5_lineages.csv")
io$anno_dir <- paste0(io$data_dir, "/features/sjc/motifs/motifdb/")
io$anno_selection_out <- paste0(io$base_dir, "/acc/motifs/profiles/out/anno_selection_lineages.rds")
# io$annotation_out <- paste0(io$data_dir, "/features/sjc/motifs/curated/motifs_all-all-stages.bed")
