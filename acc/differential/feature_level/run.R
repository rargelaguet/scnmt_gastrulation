...
opts$anno <- c(
  "CGI",
  # "H3K27ac_distal_E7.5_Ect",
  # "H3K27ac_distal_E7.5_End",
  # "H3K27ac_distal_E7.5_Mes",
  ...
  # "H3K27ac_promoter_E7.5_Mes",
  # "H3K27ac_promoter_E7.5_Ect",
  # "H3K27ac_promoter_E7.5_End",
...
for (group in names(opts$groups)) {
  ...
  for (anno in opts$anno) {
    ...
    lsf <- sprintf("bsub -M 4096 -n 1 -q standard -o %s/%s_%s.txt", io$tmpdir, group, anno)
    # lsf <- ""
