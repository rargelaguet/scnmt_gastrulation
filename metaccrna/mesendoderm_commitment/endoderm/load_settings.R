...
io$diff.met <- "/Users/ricard/data/gastrulation/met/results/differential/feature_level"
io$diff.acc <- "/Users/ricard/data/gastrulation/acc/results/differential/feature_level"
