...
if (is.null(args$trial)) args$trial <- 2
...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  source("/homes/ricard/gastrulation/metaccrna/mofa/full/load_settings.R")
  use_python("/nfs/software/stegle/users/ricard/anaconda/bin/python")
}

# Load data
if (grepl("ricard",Sys.info()['nodename'])) {
  source("/Users/ricard/gastrulation/metaccrna/mofa/full/load_data.R")
} else {
  source("/homes/ricard/gastrulation/metaccrna/mofa/full/load_data.R")
}
