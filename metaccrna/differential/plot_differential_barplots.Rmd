...
foo <- diff.met[anno=="H3K27ac_distal_E7.5_Ect_intersect12" & lineage=="Endoderm"]
foo.filt <- foo[sig==T & diff>0]
table(foo.filt$diff>0)

foo <- diff.met[anno=="H3K27ac_distal_E7.5_Ect_intersect12" & lineage=="Mesoderm"]
foo.filt <- foo[sig==T & diff>0]
table(foo.filt$diff>0)
```
